# Bayu Pratama — Software Engineer Portfolio

A production-ready personal portfolio for **Bayu Pratama Agus Kurniawan**, built with Next.js, React, TypeScript, and Tailwind CSS.
